...
//NOTE parse expression takes scope in for expr identifiers to
//see if they are in the scope or not

typedef enum
{
    Expression_None = 0,
    
    Expression_Identifier, //has to have decl at parse
    ...
    //NOTE we still need to implement this somewhow
...
typedef struct expression
{
    ...
    union
    {
        ...
        struct{
            char *identifier;
            declaration *decl; //determins if defined or not
        };
        ...
        { 
            ...
            struct expression *last_member;
        };
        struct
        {
            struct expression *member_expression;
            struct expression *member_next;
...
//expression *expr_zero_float;
//expression *expr_zero_double;
